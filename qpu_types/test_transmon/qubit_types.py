...
"""Test transmon qubits and parameters."""
...
class TestTransmonQubitParameters(QuantumParameters):
...
@classformatter
@attrs.define
class TestTransmonQubit(QuantumElement):
    """A class for a superconducting, flux-tuneable Transmon Qubit."""

    PARAMETERS_TYPE = TestTransmonQubitParameters
    REQUIRED_SIGNALS = ("acquire", "drive", "measure")
    OPTIONAL_SIGNALS = ("drive_ef", "flux", "th_res")
    SIGNAL_ALIASES = {
