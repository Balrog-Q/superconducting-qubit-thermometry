...
from .qubit_types import TestTransmonQubit
...
class TestTransmonOperations(dsl.QuantumOperations):
    """Operations for TunableTransmonQubits."""

    QUBIT_TYPES = TestTransmonQubit
    ...
    def barrier(self, q: TestTransmonQubit) -> None:
    ...
    @dsl.quantum_operation
    def delay(self, q: TestTransmonQubit, time: float) -> None:
    ...
    @dsl.quantum_operation
    def measure_section_length(qubits: TestTransmonQubit) -> float:
        ...
        #       currently.
        return max(
            [q.readout_integration_parameters()[1]["length"] for q in qubits]
            + [q.readout_parameters()[1]["length"] for q in qubits]
        )
    ...
    @dsl.quantum_operation
    def z90(self, q: TestTransmonQubit, transition: str | None = None) -> None:
    ...
    @dsl.quantum_operation
    def z180(self, q: TestTransmonQubit, transition: str | None = None) -> None:
    ...
    def active_reset(
        ...
        Arguments:
            ...
            measure_section_length:
                ...
                Default: None.
        """
        if isinstance(qubits, TestTransmonQubit):
            qubits = [qubits]
